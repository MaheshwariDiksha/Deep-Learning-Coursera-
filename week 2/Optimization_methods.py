...
def update_parameters_with_gd(parameters, grads, learning_rate):
    ...
    for l in range(1, L + 1):
        ...
        parameters["W" + str(l)] = parameters["W" + str(l)] - (learning_rate * grads['dW' + str(l)])  ## None
        parameters["b" + str(l)] = parameters["b" + str(l)] - (learning_rate * grads['db' + str(l)])  ## None
...
def initialize_velocity(parameters):
    ...
    for l in range(1, L + 1):
        ...
        # v["db" + str(l)] =
        # YOUR CODE STARTS HERE
        v["dW" + str(l)] = np.zeros((parameters["W" + str(l)].shape[0], parameters["W" + str(l)].shape[1])) ##None
        v["db" + str(l)] = np.zeros((parameters["b" + str(l)].shape[0], parameters["b" + str(l)].shape[1])) ##None
...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    for l in range(1, L + 1):
        ...
        # YOUR CODE STARTS HERE
        # compute velocities
        v["dW" + str(l)] = beta * v["dW" + str(l)] + (1 - beta) * grads['dW' + str(l)] ##None
        v["db" + str(l)] = beta * v["db" + str(l)] + (1 - beta) * grads['db' + str(l)] ##None
        # update parameters
        parameters["W" + str(l)] = parameters["W" + str(l)] - learning_rate * v["dW" + str(l)] ##None
        parameters["b" + str(l)] = parameters["b" + str(l)] - learning_rate * v["db" + str(l)] ##None
...
def initialize_adam(parameters) :
    ...
    # (approx. 4 lines)
        ...
        # s["db" + str(l)] = ...
    # YOUR CODE STARTS HERE
        v["dW" + str(l)] = np.zeros_like(parameters["W" + str(l)]) ##None
        v["db" + str(l)] = np.zeros_like(parameters["b" + str(l)]) ##None
        s["dW" + str(l)] = np.zeros_like(parameters["W" + str(l)]) ##None
        s["db" + str(l)] = np.zeros_like(parameters["b" + str(l)]) ##None
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(1, L + 1):
        ...
        v["dW" + str(l)] = beta1 * v["dW" + str(l)] + (1 - beta1) * grads["dW" + str(l)] ##None
        v["db" + str(l)] = beta1 * v["db" + str(l)] + (1 - beta1) * grads["db" + str(l)] ##None
        # YOUR CODE ENDS HERE
        ...
        # YOUR CODE STARTS HERE
        v_corrected["dW" + str(l)] = v["dW" + str(l)] / (1 - np.power(beta1,t)) ##None
        v_corrected["db" + str(l)] = v["db" + str(l)] / (1 - np.power(beta1,t)) ##None
        ...
        # s["db" + str(l)] = ...
        # YOUR CODE STARTS HERE
        s["dW" + str(l)] = beta2 * s["dW" + str(l)] + (1 - beta2) * np.power(grads["dW" + str(l)],2) ##None
        s["db" + str(l)] = beta2 * s["db" + str(l)] + (1 - beta2) * np.power(grads["db" + str(l)],2) ##None
        ...
        # YOUR CODE STARTS HERE
        s_corrected["dW" + str(l)] = s["dW" + str(l)] / (1 - np.power(beta2,t)) ##None
        s_corrected["db" + str(l)] = s["db" + str(l)] / (1 - np.power(beta2,t)) ##None
        ...
        # parameters["b" + str(l)] = ...
        # YOUR CODE STARTS HERE
        parameters["W" + str(l)] = parameters["W" + str(l)] - learning_rate *  v_corrected["dW" + str(l)] / (np.sqrt(s_corrected["dW" + str(l)]) + epsilon) ##None
        parameters["b" + str(l)] = parameters["b" + str(l)] - learning_rate *  v_corrected["db" + str(l)] / (np.sqrt(s_corrected["db" + str(l)]) + epsilon) ##None
